        ...
        >
          <div className="flex flex-col justify-center items-center h-[100%]">
            ...
            <button
              ...
              onClick={uploadPost}
              className="w-[50%] bg-orange-600 text-white p-2 shadow-md hover:brightness-125 disabled:bg-gray-200 disabled:cursor-not-allowed disabled:hover:brightness-100 "
            >
              Upload Post
            </button>
          </div>
